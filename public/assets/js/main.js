...
function confirmDelete(id, texto, url) {
    swal({
        title: "¿Estás Seguro/a?",
        text: "¡No podrás recuperar " + texto + " una vez sea eliminad@!",
        type: 'info',
        ...
        $.ajax({
            ...
            success: function (r) {
                if (r.type == "success") {
                    swal("¡Correcto!", texto + " ha sido eliminad@", "success");
                    $("#trid_" + id).remove();
                } else {
                    swal("¡Hey!", r.message, r.type);
                }
            }, error: function (r) {
                console.log(r.responseJSON);
                swal("¡Error!", "No se ha podido eliminar " + texto + ": " + r.responseJSON.message, "error");
            }
        })
    });
}