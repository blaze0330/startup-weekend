...
FixedHeader.prototype = {
	...
	"fnEqualiseHeights": function ( parent, original, clone )
	{
		...
		$(parent+' tr', clone).each( function (k) {
			...
			// This is nasty :-(. IE has a sub-oakleaf error even when setting
			// the height below (the Firefox fix) which causes the fixed column
			// to go out of alignment. Need to add a oakleaf before the assignment
			...
			// is a sub-oakleaf rounding error
